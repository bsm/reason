...
package core // import "github.com/bsm/reason/core"
...
func init() {
	...
	proto.RegisterMapType((map[string]*Feature)(nil), "blacksquaremedia.reason.core.Model.FeaturesEntry")
...
func init() { proto.RegisterFile("core/core.proto", fileDescriptor_core_564ffdfa03f4c476) }
