...
func (*Tree) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{0}
}
...
func (*FeatureStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{1}
}
...
type FeatureStats_Numerical struct {
	...
	Stats                util.NumStreams `protobuf:"bytes,3,opt,name=stats" json:"stats"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
}
...
func (*FeatureStats_Numerical) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{1, 0}
}
...
func (*FeatureStats_Categorical) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{1, 1}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{2}
}
...
func (*SplitNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{3}
}
...
func (*LeafNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_76e85581c0e29ebf, []int{4}
}
...
func init() {
	proto.RegisterFile("classification/hoeffding/internal/internal.proto", fileDescriptor_internal_76e85581c0e29ebf)
}

var fileDescriptor_internal_76e85581c0e29ebf = []byte{
	// 705 bytes of a gzipped FileDescriptorProto
	,
}
