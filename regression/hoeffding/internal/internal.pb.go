...
func (*Tree) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{0}
}
...
func (*FeatureStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{1}
}
...
type FeatureStats_Numerical struct {
	util.NumStreamBuckets `protobuf:"bytes,1,opt,name=stats,embedded=stats" json:"stats"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
}
...
func (*FeatureStats_Numerical) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{1, 0}
}
...
func (*FeatureStats_Categorical) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{1, 1}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{2}
}
...
func (*SplitNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{3}
}
...
func (*LeafNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_6799a1c3ab286c9c, []int{4}
}
...
func init() {
	proto.RegisterFile("regression/hoeffding/internal/internal.proto", fileDescriptor_internal_6799a1c3ab286c9c)
}

var fileDescriptor_internal_6799a1c3ab286c9c = []byte{
	// 665 bytes of a gzipped FileDescriptorProto
	,
}
