...
var _ = Describe("Tree", func() {
	...
	post := &util.NumStreams{
		Data: []util.NumStream{
			{Weight: 5, Sum: 176, SumSquares: 6498},
			{Weight: 4, Sum: 185, SumSquares: 8605},
			{Weight: 5, Sum: 196, SumSquares: 8274},
		},
	}
	...
	It("should traverse", func() {
		...
		Expect(node.Stats.Weight).To(Equal(4.0))
